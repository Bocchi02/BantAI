...
export function ShieldLogoMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
      {/* Outer Shield Geometry */}
      <path
        d="M24 3L42 9V22C42 33.6 34.3 42.4 24 45C13.7 42.4 6 33.6 6 22V9L24 3Z"
        fill="#071E4A"
      />
      {/* Faceted Geometry - Left Wing */}
      <path
        d="M24 3L6 9V22C6 33.6 13.7 42.4 24 45V24L12 14L24 3Z"
        fill="#04142F"
      />
      {/* Faceted Geometry - Right Upper Wing */}
      <path
        d="M24 3L42 9V22C42 28.5 39.5 34.4 35 38.8L24 24L36 14L24 3Z"
        fill="#087EFF"
      />
      {/* Angular Guardian / Shield Core Facets */}
      <path
        d="M24 10L32 16L24 32L16 16L24 10Z"
        fill="#1495FF"
      />
      {/* Inner Highlight Geometry */}
      <path
        d="M24 10L24 32L16 16L24 10Z"
        fill="#FFFFFF"
        fillOpacity="0.9"
      />
      {/* Bottom Anchor Accent */}
      <path
        d="M24 32L30 24L24 38L18 24L24 32Z"
        fill="#EAF4FF"
      />
    </svg>
  );
