    ...
    return (<main className="min-h-screen bg-gradient-to-b from-[#04142F] via-[#071E4A] to-[#04142F] text-slate-100 flex flex-col selection:bg-[#087EFF] selection:text-white">
      ...
      <header className="w-full max-w-7xl mx-auto px-6 h-20 flex items-center justify-between z-10 border-b border-slate-800/60">
        ...
        <div className="flex items-center gap-3">
          {!authenticated && (<button className="text-xs font-semibold text-slate-200 hover:text-white px-3 py-2 transition-colors" onClick={() => onNavigate("/login")}>
              Sign in
            </button>)}
          <button className="text-xs font-semibold bg-[#087EFF] hover:bg-[#1495FF] text-white px-4 py-2 rounded-xl transition-all shadow-md shadow-[#087EFF]/25 active:scale-95" onClick={() => onNavigate(authenticated ? "/dashboard" : "/register")}>
