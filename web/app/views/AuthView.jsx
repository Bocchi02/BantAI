      ...
      <section className="hidden lg:flex lg:col-span-5 flex-col justify-between p-12 bg-gradient-to-b from-[#071e4a] via-[#04142f] to-[#071e4a] text-white relative overflow-hidden">
        ...
        <div className="relative z-10 my-auto max-w-md">
          <p className="text-[11px] font-bold text-[#696cff] tracking-wider uppercase mb-2">
            LOCAL DETECTION + SHARED INSIGHTS
          </p>
          <h1 className="text-3xl xl:text-4xl font-extrabold tracking-tight leading-tight mb-4">
            Your browsing stays yours.
          </h1>
          <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mb-6">
            Privacy-first local website and email detection with minimized
            shared insights. BantAI analyzes sensitive content on your computer,
            then shares only minimized outcomes with this dashboard.
          </p>
...
function AuthScreen({ onAuthenticated, initialPath }) {
  const [path, setPath] = useState(
    initialPath === "/register" ? "/register" : "/login",
  );
